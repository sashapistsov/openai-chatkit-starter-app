...
- (optional) `AUTH_USERNAME` - Username for basic authentication (defaults to `admin`)
- (optional) `AUTH_PASSWORD` - Password for basic authentication (defaults to `password`)
